...
class _AdminProdukScreenState extends State<AdminProdukScreen> {
  ...
  Future<void> fetchProduk() async {
    final res = await http.get(Uri.parse('http://192.168.100.228:5000/produk'));
  ...
  Future<void> simpanProduk() async {
    ...
    final url = editingId == null
        ? 'http://192.168.100.228:5000/produk'
        : 'http://192.168.100.228:5000/produk/$editingId';
  ...
  Future<void> hapusProduk(int id) async {
    final res = await http.delete(Uri.parse('http://192.168.100.228:5000/produk/$id'));
    if (res.statusCode == 200) {
      fetchProduk();
    }
  }
